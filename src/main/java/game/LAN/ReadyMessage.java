...
public class ReadyMessage extends Message {
    ...
    public ReadyMessage(int oppColor, String name, long timePerSide, long timePerMove) {

        super("ready", oppColor + "", name, timePerSide + "", timePerMove + "");
    ...
    public ReadyMessage(String msg) throws Exception {
        ...
        try {
            this.timePerSide = Long.parseLong(args.get(3));
        } catch (Exception e) {
            throw new Exception("Invalid time per side.");
        }

        try {
            this.timePerMove = Long.parseLong(args.get(4));
        } catch (Exception e) {
